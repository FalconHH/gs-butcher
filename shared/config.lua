...
--Blip Settings
Config.Blips = {
    {title = 'Etse Et (Kasap)', colour = 0, id = 273, coords = vector3(-73.59, 6267.08, 31.32), scale = 0.7, useblip = true}, -- BLIP FOR CHICKEN FACTORY
}
...
Config.CoreSettings = {
    ...
    Inventory = {
        Type = 'codem', -- support for qb-inventory and ox_inventory
    ...
    Clothing = {
        Type = 'custom' -- clothing type, support for qb-clothing and illenium-appearance
